namespace Simulator {
	partial class ControlPanel {
		...
		private void InitializeComponent ()
		{
			...
			this.PitchRollDiagram.Series.Add(series2);
			this.PitchRollDiagram.Series.Add(series3);
			...
			this.AngularPhaseDiagram.Series.Add(series4);
			...
			this.AltitudeDiagram.Series.Add(series5);
			...
			this.LinearPhaseDiagram.Series.Add(series6);
