...
set cmd=avrdude -C "!arduino_path!\hardware\tools\avr\etc\avrdude.conf" -p !arduino_mcu! -P !arduino_comport! -c !arduino_programmer! -b !arduino_burnrate! -D -U "flash:w:!hexfile!:i"
!abuild_report! !cmd!
!cmd!
set rc=!errorlevel!
goto end
